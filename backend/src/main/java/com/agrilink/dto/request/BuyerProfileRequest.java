...
public class BuyerProfileRequest {
    ...
    public BuyerProfileRequest() {
    }

    public BuyerProfileRequest(String businessName, BuyerType buyerType, String gstin, String address, String district, String state, String pincode) {
